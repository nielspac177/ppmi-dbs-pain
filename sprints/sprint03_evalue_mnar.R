...
print(ev_tbl)
save_table(ev_tbl, "sprint03_evalue_table_E1")
...
drop_tbl <- joined %>%
  ...
  dplyr::summarise(n = dplyr::n(),
                   ...
                   .groups = "drop")
print(drop_tbl)
save_table(drop_tbl, "sprint03_dropout_by_arm")
...
print(mnar_tbl)
save_table(mnar_tbl, "sprint03_mnar_tipping")
...
save_fig_pub(p, "sprint03_mnar_tipping", width = 9, height = 5)

cat("\n[OK] sprint03 outputs saved.\n")
