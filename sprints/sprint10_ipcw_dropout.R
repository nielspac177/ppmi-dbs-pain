...
here::i_am("sprints/sprint10_ipcw_dropout.R")
...
print(drop_tbl)
save_table(drop_tbl, "sprint10_dropout_rates")
...
print(res)
save_table(res, "sprint10_ipcw_results")
...
save_fig_pub(p, "sprint10_dropout_model", width = 9, height = 4.5)

cat("\n[OK] sprint10 outputs saved.\n")
