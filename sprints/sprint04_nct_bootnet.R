...
#
# Outputs:
#   - sprint04_nct_results.csv (global tests per window)
#   - sprint04_pain_edge_ci.csv (Pain-anchored edges with CIs)
#   - sprint04_pain_neighbours.{png,pdf}
# ------------------------------------------------------------
...
print(nct_tbl)
save_table(nct_tbl, "sprint04_nct_global")

edge_ci_tbl <- dplyr::bind_rows(edge_ci_list)
print(head(edge_ci_tbl, 20))
save_table(edge_ci_tbl, "sprint04_pain_edge_ci")

# Save objects for downstream plotting
save_object(nct_results, "sprint04_nct_objects")
save_object(edge_ci_list, "sprint04_edge_ci_objects")
...
save_fig_pub(p, "sprint04_pain_neighbours", width = 11, height = 5.5)
cat("\n[OK] sprint04 outputs saved.\n")
