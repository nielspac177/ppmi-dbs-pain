...
print(res)
save_table(02$NAME, "02_anchor_sensitivity")
...
save_fig_pub(02$NAME, "02_anchor_sensitivity", width = 9.5, height = 4)
cat("\n[OK] 02_anchor_sensitivity saved.\n")
