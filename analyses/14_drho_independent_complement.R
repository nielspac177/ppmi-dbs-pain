#!/usr/bin/env Rscript
# 14_drho_independent_complement.R
# ------------------------------------------------------------
...
here::i_am("sprints/14_drho_independent_complement.R")
...
print(res)
save_table(14$NAME, "14_drho_independent")
...
save_fig_pub(14$NAME, "14_drho_independent", width = 10, height = 4)
cat("\n[OK] 14 outputs saved.\n")
