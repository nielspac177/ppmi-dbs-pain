...
#
# Outputs:
#   - outputs/tables/01_negative_controls.csv (Δ + 95% CI + TOST)
#   - outputs/figures/01_negative_controls.{png,pdf}
# ------------------------------------------------------------
...
print(all_res, n = 50)
save_table(01$NAME, "01_negative_controls")
...
save_fig_pub(01$NAME, "01_negative_controls", width = 9.5, height = 4.5)
cat("\n[OK] 01_negative_controls saved.\n")
