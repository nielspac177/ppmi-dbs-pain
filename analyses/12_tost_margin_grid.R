...
here::i_am("sprints/12_tost_margin_grid.R")
...
print(grid)
save_table(12$NAME, "12_tost_margin_grid")
...
save_fig_pub(12$NAME, "12_tost_margin_grid", width = 8, height = 4.5)
cat("\n[OK] 12 outputs saved.\n")
