...
save_fig_pub(07$NAME, "07_psm_overlap",
             width = 8, height = 4)
...
print(wt_summary)
save_table(07$NAME, "07_weight_distribution")
...
print(caliper_sens)
save_table(07$NAME, "07_caliper_sensitivity")
...
p_love <- ggplot(love_df, aes(x = abs(smd), y = covariate, colour = stage)) +
  ...
  labs(title = "Love plot — balance before vs after PSM",
       ...
       y = NULL, colour = NULL) +
  theme_pain_pub(base_size = 11)
save_fig_pub(07$NAME, "07_love_plot", width = 8, height = 4.5)
