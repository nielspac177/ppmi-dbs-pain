...
| 2 | TOST margin too wide | TODO | Add `Analysis 12_tost_margin_grid.R` testing ±0.3 / 0.5 / 0.75 / 1.0; defend chosen margin against PPMI-derived MCID. |
| 3 | Bayesian GBA reconciliation | TODO | Re-run Analysis 11 on **real** patient-level genetics data; resolve frequentist/Bayesian inconsistency. Flag as hypothesis-generating if real signal. |
| 4 | Immortal-time / anchor asymmetry | TODO | Add `Analysis 13_clone_censor_weight.R` sequential-trial emulation. |
