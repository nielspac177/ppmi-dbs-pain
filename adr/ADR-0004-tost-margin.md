...
- Status: **Accepted (under reviewer scrutiny — see Analysis 12 follow-up)**
- Date: 2026-05-19
...
sensitivity (±0.3, 0.5, 0.75, 1.0)** in `Analysis 12_tost_margin_grid.R`
...
- Conservative non-inferiority claim. If DBS were ±1-point harmful,
  ...
  important.
- Computationally trivial to extend to a grid (Analysis 12 forthcoming).
