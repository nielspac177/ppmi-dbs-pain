...
- Unit tested.
- Three numbered analyses (Analysis 02, Analysis 05) that previously
...
- **Use the cohort-median anchor for Never-DBS** (the legacy
  ...
  alignment. Used as the cohort-median sensitivity (`Analysis 02`).
- **Use each patient's first visit as anchor.** No symmetric pre/post
  window. Used as the patient-anchor sensitivity (`Analysis 02`).
